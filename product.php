...
<body id="container-page-product">
    ...
    <section id="store">
       ...
       <div class="container">
        ...
        ?>
            ...
            <div class="row">
                ...
                if ($categoria) {
                    ...
                    echo '<h3 class="text-center"></h3><br>';
                }
                ...
                ?>
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="thumbnail">
                                <img class="img-product" src="./assets/img-products/<?php echo ($prod['Imagen'] != "" && is_file("./assets/img-products/".$prod['Imagen'])) ? $prod['Imagen'] : "default.png"; ?>">
                                <div class="caption">
                ...
                ?>
                    ...
                    <div class="text-center">
                        <ul class="pagination">
                            ...
                            <?php else: ?>
                                <li><a href="product.php?categ=<?php echo $categoria; ?>&pag=<?php echo $pagina-1; ?>"><span aria-hidden="true">&laquo;</span></a></li>
                            <?php endif; ?>
                            <?php
                            for ($i = 1; $i <= $numeropaginas; $i++) {
                                echo ($pagina == $i) ? '<li class="active"><a href="product.php?categ='.$categoria.'&pag='.$i.'">'.$i.'</a></li>' : '<li><a href="product.php?categ='.$categoria.'&pag='.$i.'">'.$i.'</a></li>';
                            }
                            ?>
                            <?php if ($pagina == $numeropaginas): ?>
                                <li class="disabled"><a><span aria-hidden="true">&raquo;</span></a></li>
                            <?php else: ?>
                                <li><a href="product.php?categ=<?php echo $categoria; ?>&pag=<?php echo $pagina+1; ?>"><span aria-hidden="true">&raquo;</span></a></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                <?php
        ...
        <?php else: ?>
            <h2 class="text-center">No hay categorías ni productos registrados en la tienda</h2>
        <?php endif; ?>
    </div>
